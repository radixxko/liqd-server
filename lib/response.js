...
module.exports = class Response
{
	...
	reply( code, data, type, callback )
	{
		...
		{
			this._response.setHeader( 'Content-Type', type ? ( type.includes('charset') ? type : type + '; charset=utf-8' ) : 'text/plain; charset=utf-8' );
	...
	redirect( code, location, callback = undefined )
	{
		if( typeof code !== 'number' ){[ code, location, callback ] = [ 302, location, callback ]}

		this._response.writeHead( code, { 'Location' : location });
